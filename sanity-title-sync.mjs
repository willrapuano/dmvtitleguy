 ...
 *   SANITY_API_TOKEN=... node sanity-title-sync.mjs --apply
 *
...
if (!APPLY) {
  ...
  console.log(`\nDRY RUN — re-run with --apply and SANITY_API_TOKEN set.`);
  process.exit(0);
}
if (!TOKEN) { console.error("SANITY_API_TOKEN is not set — refusing to apply."); process.exit(1); }
