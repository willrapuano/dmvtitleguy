...
export const TIER2_LOCATIONS: Location[] = [
  ...
  { city: "Herndon",          slug: "title-company-herndon-va",          state: "VA", county: "Fairfax County",          tier: 2, faqs: [
      ...
      { question: "Does Pruitt Title handle title closings in Herndon VA?", answer: "Yes. Pruitt Title handles Herndon VA title closings for purchases, refinances, investors, agents, lenders, builders, and commercial transactions, including escrow, settlement coordination, recording, and post-closing title policy work." },
      { question: "Can I order a Herndon title search online?", answer: "Yes. You can order your title search online or request a title quote, and the Pruitt Title team will follow up with the next steps for the property, contract, lender requirements, and closing timeline." },
