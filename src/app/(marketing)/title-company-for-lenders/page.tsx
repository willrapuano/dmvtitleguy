    ...
    <>
      ...
      <section className="py-16 bg-white">
        <div className="container-xl">
          <h2 className="text-3xl font-bold text-brand-navy mb-8">Why Lenders Trust DMV Title Guy</h2>
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-brand-navy mb-3">Fast Turnaround</h3>
              <p className="text-gray-600">We meet your funding deadlines with quick title commitments.</p>
            </div>
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-brand-navy mb-3">Online Status Tracking</h3>
              <p className="text-gray-600">Real-time updates on title status through your pipeline.</p>
            </div>
            <div className="bg-gray-50 rounded-xl p-6">
              <h3 className="text-xl font-semibold text-brand-navy mb-3">Competitive Rates</h3>
      ...
      <section className="py-16 bg-brand-navy">
        <div className="container-xl text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Become a Lending Partner</h2>
