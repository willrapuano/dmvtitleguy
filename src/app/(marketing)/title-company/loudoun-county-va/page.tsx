...
export const metadata: Metadata = {
  ...
  description: "Pruitt Title LLC provides expert title and settlement services in Loudoun County, VA. Fast closings, competitive rates, and local expertise since 2007.",
  ...
  return (
    <>
      ...
      <section className="section-gray">
        <div className="container-xl max-w-3xl">
          <h2 className="text-2xl font-bold text-brand-navy mb-4">Why Loudoun County Real Estate Matters</h2>
      ...
      <section className="py-16 bg-white">
        <div className="container-xl">
          <h2 className="text-3xl font-bold text-brand-navy mb-8">Title Services in Loudoun County</h2>
      ...
      <section className="section-light">
        <div className="container-xl">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Link href="/title-company/prince-william-county-va" className="text-brand-blue hover:underline">
      ...
      <section className="py-16 bg-brand-navy">
        <div className="container-xl text-center">
          <h2 className="text-3xl font-bold text-white mb-4">Get Your Loudoun County Title Quote</h2>
