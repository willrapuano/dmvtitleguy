    ...
    <>
      ...
      <header className="border-b border-slate-100 bg-white">
        <div className="mx-auto max-w-6xl px-6 pb-10 pt-10 md:pb-12 md:pt-14">
          ...
          <div
            className="relative aspect-[16/9] overflow-hidden rounded-2xl bg-brand-navy  md:aspect-[21/9]"
            data-blog-hero
          >
            <Image
              src={heroImage}
          ...
          <div className="mt-8 max-w-4xl md:mt-10">
            {/* Category tag */}
            <span className="mb-4 inline-flex rounded-none bg-brand-gray-bg px-3 py-1 text-xs font-semibold uppercase tracking-wide text-brand-blue-deep">
              {post.category}
            </span>
            ...
            <div className="mt-6 flex flex-wrap items-center gap-2">
              ...
              <a
                ...
                className="inline-flex min-h-9 items-center gap-1.5 rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-medium text-slate-600 transition-[background-color,border-color,color] duration-150 hover:border-brand-blue-600 hover:bg-brand-blue-600 hover:text-white"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex min-h-9 items-center gap-1.5 rounded-lg border border-slate-200 px-3 py-1.5 text-xs font-medium text-slate-600 transition-[background-color,border-color,color] duration-150 hover:border-brand-blue-700 hover:bg-brand-blue-700 hover:text-white"
              >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <article className="lg:col-span-2 min-w-0">
              ...
              {!isViennaTitleCompanyPost && (
                <div className="mb-8 rounded-xl border border-brand-blue/20 bg-brand-gray-bg p-5 lg:hidden">
              ...
              {isViennaTitleCompanyPost && (
                <div className="mb-8 rounded-xl border border-brand-blue/20 bg-brand-gray-bg p-6">
