...
export const EMBED_SNIPPET = `<iframe id="dmvtitleguy-calculator" src="https://dmvtitleguy.io/embed/closing-costs" title="Pruitt Title quote and closing cost calculator" loading="lazy" style="width:100%;height:960px;border:0"></iframe>
<p style="font:13px/1.5 sans-serif;margin:6px 0 0">Pruitt Title calculator, shared by <a href="https://dmvtitleguy.io/?utm_source=embed&amp;utm_medium=widget&amp;utm_campaign=pruitt-calculator" rel="nofollow">DMV Title Guy</a></p>
