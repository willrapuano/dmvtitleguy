  ...
  return (
    <div className="grid lg:grid-cols-2 gap-8">
      ...
      <div className="space-y-4">
        ...
        <div>
          <label htmlFor="flip-arv" className={labelClass}>After Repair Value (ARV)</label>
          <div className="relative"><span aria-hidden="true" className="absolute left-3 top-3.5 text-gray-600 text-sm">$</span>
            <input id="flip-arv" type="number" placeholder="350,000" value={arv} onChange={e => setArv(e.target.value)} className={inputClass + " pl-7"} />
          </div>
        </div>
        <div>
          <label htmlFor="flip-purchase-price" className={labelClass}>Purchase Price</label>
          <div className="relative"><span aria-hidden="true" className="absolute left-3 top-3.5 text-gray-600 text-sm">$</span>
            <input id="flip-purchase-price" type="number" placeholder="200,000" value={purchase} onChange={e => setPurchase(e.target.value)} className={inputClass + " pl-7"} />
          </div>
        </div>
        <div>
          <label htmlFor="flip-rehab-cost" className={labelClass}>Rehab / Renovation Cost</label>
          <div className="relative"><span aria-hidden="true" className="absolute left-3 top-3.5 text-gray-600 text-sm">$</span>
            <input id="flip-rehab-cost" type="number" placeholder="50,000" value={rehab} onChange={e => setRehab(e.target.value)} className={inputClass + " pl-7"} />
          </div>
        </div>
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="flip-holding-period" className={labelClass}>Holding Period (months)</label>
            <input id="flip-holding-period" type="number" placeholder="6" value={holdingMonths} onChange={e => setHoldingMonths(e.target.value)} className={inputClass} />
          </div>
          <div>
            <label htmlFor="flip-holding-cost" className={labelClass}>Holding Cost (% ARV/yr)</label>
            <div className="relative"><input id="flip-holding-cost" type="number" step="0.1" placeholder="1.0" value={holdingCostPct} onChange={e => setHoldingCostPct(e.target.value)} className={inputClass + " pr-7"} />
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            <label htmlFor="flip-closing-costs" className={labelClass}>Closing Costs (% ARV)</label>
            <div className="relative"><input id="flip-closing-costs" type="number" step="0.1" placeholder="2.0" value={closingCostPct} onChange={e => setClosingCostPct(e.target.value)} className={inputClass + " pr-7"} />
              <span aria-hidden="true" className="absolute right-3 top-3.5 text-gray-600 text-sm">%</span>
            </div>
          </div>
          <div>
            <label htmlFor="flip-desired-profit" className={labelClass}>Desired Profit (MAO calc)</label>
            <div className="relative"><span aria-hidden="true" className="absolute left-3 top-3.5 text-gray-600 text-sm">$</span>
              <input id="flip-desired-profit" type="number" placeholder="20,000" value={desiredProfit} onChange={e => setDesiredProfit(e.target.value)} className={inputClass + " pl-7"} />
            </div>
          </div>
        </div>
      </div>
      ...
      <div>
        ...
        {!results ? (
          <div className="surface-subtle p-6 text-center text-brand-muted text-sm">Enter ARV to see your numbers</div>
        ) : (
